$( document ).ready(function() {
    ...
    window.DevelopxTK = function (points, cityName, path) {
        this.points = points;
        this.path = path;
    ...
    window.DevelopxTK.prototype = {
        ...
        Y_addPoints: function(){
            ...
            for(var i in $this.points){
                ...
                baloonHTML += "<div class='pointTitle'>" + point['TITLE'] + "</div>";
                baloonHTML += "<div class='pointPrice'>" + point['PRICE'] + " руб</div>";
                baloonHTML += "<div class='pointTime'>" + point['TIME_FORMAT'] + "</div>";
        ...
        L_addPoints: function(){
            ...
            for(var i in $this.points){
                ...
                baloonHTML  += '</td>';
                baloonHTML  += '<td>' + point['PRICE'] + ' руб</td>';
                baloonHTML  += '<td class="time">' + point['TIME_FORMAT'] + '</td>';
                baloonHTML  += '</tr>';
